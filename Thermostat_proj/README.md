Using C code, build a thermostat that monitors the room temperature and controls heating/air conditioning devices based on the desired temperature set on the thermostat.
